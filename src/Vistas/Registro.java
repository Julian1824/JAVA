...
public class Registro extends javax.swing.JFrame {
    ...
    public Registro() {
        ...
        if("Seleccione".equals(cbxRol.getSelectedItem())){
            JOptionPane.showMessageDialog(null, "Seleccione un perfil");        
        }else{if(!"".equals(correo) || !"".equals(password) || !"".equals(txtNombre.getText())){
            lg.setNombre(nom);
            lg.setCorreo(correo);
    ...
    private void initComponents() {
        ...
        cbxRol.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccione", "Administrador", "Asistente" }));
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 20, -1, 390));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/login.jpg"))); // NOI18N
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, -30, 310, 500));

        jPanel1.setBackground(new java.awt.Color(0, 0, 153));

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/Captura_de_pantalla_2022-06-22_205505-removebg-preview-removebg-preview.png"))); // NOI18N

        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("BY: JBS");
